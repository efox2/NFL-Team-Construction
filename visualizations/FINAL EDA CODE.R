...
sidebar <- dashboardSidebar(selectInput("position", "Position", choices= data%>%
                ...
                sidebarMenu(
                            ...
                            menuItem("Clustering", tabName = "Clustering of Players"),
                            menuItem("Genetic Algorithm 1", tabName = "Genetic Alg1"),
                            menuItem("Genetic Algorithm 2", tabName = "Genetic Alg2"),
                            menuItem("Genetic Algorithm 3", tabName = "Genetic Alg3")
                            )
                )
